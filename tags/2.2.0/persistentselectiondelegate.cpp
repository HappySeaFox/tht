...
PersistentSelectionDelegate::PersistentSelectionDelegate(QObject *parent)
    : QStyledItemDelegate(parent)
{}

void PersistentSelectionDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
